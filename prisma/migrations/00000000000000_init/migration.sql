...
CREATE TABLE "Transaction" (
    ...
    "reimbursedAmountCents" BIGINT NOT NULL DEFAULT 0,
    "folderId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "MerchantRule" (
    ...
    "minAmountCents" BIGINT NOT NULL DEFAULT -9007199254740000,
    "maxAmountCents" BIGINT NOT NULL DEFAULT 9007199254740000,
...
CREATE TABLE "Property" (
    ...
    "userId" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "rentIncomeCents" BIGINT NOT NULL DEFAULT 0,
    "mortgageCents" BIGINT NOT NULL DEFAULT 0,
    "utilitiesCents" BIGINT NOT NULL DEFAULT 0,
    "hoaCents" BIGINT NOT NULL DEFAULT 0,
    "sweatInCents" BIGINT NOT NULL DEFAULT 0,
    "sweatOutCents" BIGINT NOT NULL DEFAULT 0,
    "notes" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
